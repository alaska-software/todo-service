/**
 * Service DataService
 * Consists of stateless logic and has functions that send HTTP requests and receive responses from the backend.
 * @copyright Alaska Software Inc. (c) 2026. All rights reserved.
 */

import { axiosInstance } from 'src/boot/axios.js'
import qs from 'qs';
import { ERROR_MESSAGES, HTTP_ERROR_MESSAGES } from 'src/constants/messages.js';
