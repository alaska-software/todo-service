import { c as createComponent, i as inject, e as emptyRenderFn, l as layoutKey, r as ref, w as watch, n as nextTick, o as onMounted, a as onBeforeUnmount, b as withDirectives, h, d as hDir, f as hSlot, g as getCurrentInstance, j as computed, _ as _export_sfc, k as openBlock, m as createBlock, p as withCtx, q as createElementBlock, F as Fragment, s as renderList, t as createVNode, Q as QIcon, u as createTextVNode, v as toDisplayString, x as useRouter, y as resolveComponent, z as QBtn } from "./index-D97wSuWx.js";
import { Q as QHeader, a as QToolbar, b as QToolbarTitle, c as QPageContainer, d as QLayout } from "./QLayout-Dj7pzl-4.js";
import { u as useModelToggleEmits, a as useModelToggleProps, b as useTimeout, c as useModelToggle, d as useHistory, e as usePreventScroll, f as between } from "./format-DEDBY0uM.js";
import { u as useDarkProps, a as useDark } from "./use-dark-BcG_t4pz.js";
import { T as TouchPan } from "./TouchPan-CTVwpyYX.js";
import { Q as QItem, a as QItemSection, b as QItemLabel, c as QList } from "./QList-Cqp20mmE.js";
const duration = 150;
...
const _sfc_main$1 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { router, items, selectedItemName, setSelectedItemName, ref, onMounted, get useRouter() {
      return useRouter;
    } };
    ...
    default: withCtx(() => [
      (openBlock(true), createElementBlock(Fragment, null, renderList($setup.items, (item) => {
        return openBlock(), createBlock(QItem, {
          class: "text-white",
          disable: $setup.selectedItemName === item.name,
          to: { name: item.name },
          onClick: ($event) => $setup.setSelectedItemName(item.name),
          key: item.name
        }, {
          default: withCtx(() => [
          ...
          _: 2
        }, 1032, ["disable", "to", "onClick"]);
      }), 128))
    ]),
    _: 1
  });
}
const MainMenu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__file", "MainMenu.vue"]]);
const _sfc_main = {
  __name: "MainLayout",
  setup(__props, { expose: __expose }) {
    __expose();
    const leftDrawerOpen = ref(false);
    const __returned__ = { leftDrawerOpen, ref, MainMenu };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
};
          ...
          createVNode(QToolbar, { class: "bg-blue-10" }, {
            default: withCtx(() => [
              ...
              createVNode(QToolbarTitle, null, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(_ctx.$route.meta.title), 1)
                ]),
                _: 1
              }),
              _cache[2] || (_cache[2] = createTextVNode(" MyTodoEditor ", -1))
            ]),
            _: 1
          })
        ]),
